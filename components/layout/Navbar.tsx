            ...
            {user ? (
              <>
                ...
                {user.role === 'restaurant' && (
                  <Link href="/restaurant-dashboard" className="text-gray-600 hover:text-gray-900 text-sm font-medium hidden sm:block">
                    My Restaurant
                  </Link>
                )}
                {user.role === 'driver' && (
                  <Link href="/driver-dashboard" className="text-gray-600 hover:text-gray-900 text-sm font-medium hidden sm:block">
                    Driver Dashboard
                  </Link>
                )}
