...
function truncateAddress(addr: string, max = 22): string {
            ...
            <div className="flex items-center gap-2 ml-auto">
              {user ? (
                <>
                  ...
                  {user.role === 'customer' && (
                    <Link href="/orders" className="text-gray-600 hover:text-gray-900 text-sm font-medium hidden sm:block whitespace-nowrap">
                      My Orders
                    </Link>
                  )}
                  {user.role === 'restaurant' && (
                    <Link href="/restaurant-dashboard" className="text-gray-600 hover:text-gray-900 text-sm font-medium hidden sm:block whitespace-nowrap">
                      My Restaurant
                    </Link>
                  )}
                  {user.role === 'driver' && (
                    <Link href="/driver-dashboard" className="text-gray-600 hover:text-gray-900 text-sm font-medium hidden sm:block whitespace-nowrap">
                      Driver Mode
                    </Link>
                  )}
